<section class="w-full">
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4">
            <div>
                <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">{{ __('Customer Payments') }}</h3>
                <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">{{ __('Record payments from customers') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 p-4 sm:p-6 shadow-sm">
                ...
                <form wire:submit="save" class="space-y-4 sm:space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        <flux:input wire:model="payment_number" :label="__('Receipt Number')" type="text" required placeholder="REC-00001" />
                        ...
                        <flux:select wire:model.live="customer_invoice_id" :label="__('Invoice')" required>
        ...
        <div class="space-y-3">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                                ...
                                <flux:badge variant="info" size="sm">{{ $payment->customer->name }}</flux:badge>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-3 text-xs">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-zinc-900 dark:text-zinc-100 mt-1">{{ $payment->customerInvoice->invoice_number }}</p>
                                </div>
                                <div>
            ...
            @empty
                <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 p-12 text-center">
                    ...
                    <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-6">{{ __('Record your first customer payment to start tracking.') }}</p>
